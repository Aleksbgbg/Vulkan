#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEDEPTHSTENCILSTATECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEDEPTHSTENCILSTATECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEDEPTHSTENCILSTATECREATEINFO_H_
