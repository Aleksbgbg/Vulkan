#ifndef VULKAN_SRC_VULKAN_STRUCTURES_BUFFERMEMORYBARRIER_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_BUFFERMEMORYBARRIER_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_BUFFERMEMORYBARRIER_H_
