...
STRUCTURE_SETTER(ImageCreateInfoBuilder, ImageType, const VkImageType,
                 imageType)
...
STRUCTURE_SETTER_BUILDER_OBJECT(ImageCreateInfoBuilder, Extent, Extent3DBuilder,
                                extent)
...
STRUCTURE_SETTER(ImageCreateInfoBuilder, Samples, const VkSampleCountFlagBits,
                 samples)
...
STRUCTURE_SETTER(ImageCreateInfoBuilder, SharingMode, const VkSharingMode,
                 sharingMode)
STRUCTURE_SETTER(ImageCreateInfoBuilder, QueueFamilyIndexCount, const u32,
                 queueFamilyIndexCount)
STRUCTURE_SETTER(ImageCreateInfoBuilder, PQueueFamilyIndices, const u32*,
                 pQueueFamilyIndices)
STRUCTURE_SETTER(ImageCreateInfoBuilder, InitialLayout, const VkImageLayout,
                 initialLayout)
