#ifndef VULKAN_SRC_VULKAN_STRUCTURES_DEVICEQUEUECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_DEVICEQUEUECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_DEVICEQUEUECREATEINFO_H_
