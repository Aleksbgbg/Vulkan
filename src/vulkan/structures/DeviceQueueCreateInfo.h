...
STRUCTURE_SETTER(DeviceQueueCreateInfoBuilder, QueueFamilyIndex, const u32,
                 queueFamilyIndex)
STRUCTURE_SETTER(DeviceQueueCreateInfoBuilder, QueueCount, const u32,
                 queueCount)
STRUCTURE_SETTER(DeviceQueueCreateInfoBuilder, PQueuePriorities, const float*,
                 pQueuePriorities)
