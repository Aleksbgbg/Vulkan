#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECACHECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECACHECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECACHECREATEINFO_H_
