#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDSTATECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDSTATECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDSTATECREATEINFO_H_
