#ifndef VULKAN_SRC_VULKAN_STRUCTURES_IMAGEMEMORYBARRIER_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_IMAGEMEMORYBARRIER_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_IMAGEMEMORYBARRIER_H_
