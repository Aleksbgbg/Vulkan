#ifndef VULKAN_SRC_VULKAN_STRUCTURES_SUBPASSDESCRIPTION_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_SUBPASSDESCRIPTION_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_SUBPASSDESCRIPTION_H_
