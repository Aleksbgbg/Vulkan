#ifndef VULKAN_SRC_VULKAN_STRUCTURES_COMMANDPOOLCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_COMMANDPOOLCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_COMMANDPOOLCREATEINFO_H_
