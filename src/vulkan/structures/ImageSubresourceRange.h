#ifndef VULKAN_SRC_VULKAN_STRUCTURES_IMAGESUBRESOURCERANGE_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_IMAGESUBRESOURCERANGE_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_IMAGESUBRESOURCERANGE_H_
