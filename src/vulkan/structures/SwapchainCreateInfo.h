#ifndef VULKAN_SRC_VULKAN_STRUCTURES_SWAPCHAINCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_SWAPCHAINCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_SWAPCHAINCREATEINFO_H_
