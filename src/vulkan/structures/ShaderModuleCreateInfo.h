...
STRUCTURE_BUILDER(ShaderModuleCreateInfoBuilder, VkShaderModuleCreateInfo, VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO)
  STRUCTURE_SETTER(ShaderModuleCreateInfoBuilder, CodeSize, const size_t, codeSize)
