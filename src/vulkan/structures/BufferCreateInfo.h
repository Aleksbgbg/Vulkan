#ifndef VULKAN_SRC_VULKAN_STRUCTURES_BUFFERCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_BUFFERCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_BUFFERCREATEINFO_H_
