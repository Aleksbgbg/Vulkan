#ifndef VULKAN_SRC_VULKAN_STRUCTURES_FRAMEBUFFERCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_FRAMEBUFFERCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_FRAMEBUFFERCREATEINFO_H_
