#ifndef VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSBEGININFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSBEGININFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSBEGININFO_H_
