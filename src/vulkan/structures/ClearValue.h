...
STRUCTURE_SETTER_BUILDER_OBJECT(ClearValueBuilder, Color,
                                ClearColorValueBuilder, color)
STRUCTURE_SETTER(ClearValueBuilder, DepthStencil, VkClearDepthStencilValue,
                 depthStencil)
STRUCTURE_SETTER_BUILDER_OBJECT(ClearValueBuilder, DepthStencil,
                                ClearDepthStencilValueBuilder, depthStencil)
