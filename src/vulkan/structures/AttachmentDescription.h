#ifndef VULKAN_SRC_VULKAN_STRUCTURES_ATTACHMENTDESCRIPTION_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_ATTACHMENTDESCRIPTION_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_ATTACHMENTDESCRIPTION_H_
