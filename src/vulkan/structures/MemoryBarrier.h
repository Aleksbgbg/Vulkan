#ifndef VULKAN_SRC_VULKAN_STRUCTURES_MEMORYBARRIER_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_MEMORYBARRIER_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_MEMORYBARRIER_H_
