#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PHYSICALDEVICEFEATURES_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PHYSICALDEVICEFEATURES_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PHYSICALDEVICEFEATURES_H_
