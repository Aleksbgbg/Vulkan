...
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, Flags,
                 const VkImageViewCreateFlags, flags)
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, Image, VkImage, image)
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, ViewType, const VkImageViewType,
                 viewType)
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, Format, const VkFormat, format)
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, Components,
                 const VkComponentMapping, components)
STRUCTURE_SETTER(ImageViewCreateInfoBuilder, SubresourceRange,
                 const VkImageSubresourceRange, subresourceRange)
STRUCTURE_SETTER_BUILDER_OBJECT(ImageViewCreateInfoBuilder, SubresourceRange,
