#ifndef VULKAN_SRC_VULKAN_STRUCTURES_MEMORYALLOCATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_MEMORYALLOCATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_MEMORYALLOCATEINFO_H_
