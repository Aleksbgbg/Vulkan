#ifndef VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_RENDERPASSCREATEINFO_H_
