...
STRUCTURE_SETTER(CommandBufferAllocateInfoBuilder, CommandPool, VkCommandPool,
                 commandPool)
STRUCTURE_SETTER(CommandBufferAllocateInfoBuilder, Level, VkCommandBufferLevel,
                 level)
STRUCTURE_SETTER(CommandBufferAllocateInfoBuilder, CommandBufferCount,
                 const u32, commandBufferCount)
