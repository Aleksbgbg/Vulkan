#ifndef VULKAN_SRC_VULKAN_STRUCTURES_COMMANDBUFFERALLOCATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_COMMANDBUFFERALLOCATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_COMMANDBUFFERALLOCATEINFO_H_
