#ifndef VULKAN_SRC_VULKAN_STRUCTURES_INSTANCECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_INSTANCECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_INSTANCECREATEINFO_H_
