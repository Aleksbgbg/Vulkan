#ifndef VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTATTRIBUTEDESCRIPTION_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTATTRIBUTEDESCRIPTION_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTATTRIBUTEDESCRIPTION_H_
