#ifndef VULKAN_SRC_VULKAN_STRUCTURES_GRAPHICSPIPELINECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_GRAPHICSPIPELINECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_GRAPHICSPIPELINECREATEINFO_H_
