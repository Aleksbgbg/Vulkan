#ifndef VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORPOOLCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORPOOLCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORPOOLCREATEINFO_H_
