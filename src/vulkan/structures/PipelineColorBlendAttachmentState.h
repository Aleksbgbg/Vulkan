#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDATTACHMENTSTATE_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDATTACHMENTSTATE_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINECOLORBLENDATTACHMENTSTATE_H_
