...
STRUCTURE_SETTER(DescriptorSetAllocateInfoBuilder, DescriptorPool,
                 VkDescriptorPool, descriptorPool)
STRUCTURE_SETTER(DescriptorSetAllocateInfoBuilder, DescriptorSetCount, u32,
                 descriptorSetCount)
STRUCTURE_SETTER(DescriptorSetAllocateInfoBuilder, PSetLayouts,
