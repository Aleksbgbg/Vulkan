#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINESHADERSTAGECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINESHADERSTAGECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINESHADERSTAGECREATEINFO_H_
