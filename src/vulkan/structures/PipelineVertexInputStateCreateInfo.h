#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVERTEXINPUTSTATECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVERTEXINPUTSTATECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVERTEXINPUTSTATECREATEINFO_H_
