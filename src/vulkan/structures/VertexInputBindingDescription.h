#ifndef VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTBINDINGDESCRIPTION_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTBINDINGDESCRIPTION_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_VERTEXINPUTBINDINGDESCRIPTION_H_
