...
STRUCTURE_SETTER(SamplerCreateInfoBuilder, MipmapMode, VkSamplerMipmapMode,
                 mipmapMode)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, AddressModeU, VkSamplerAddressMode,
                 addressModeU)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, AddressModeV, VkSamplerAddressMode,
                 addressModeV)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, AddressModeW, VkSamplerAddressMode,
                 addressModeW)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, MipLodBias, float, mipLodBias)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, AnisotropyEnable, VkBool32,
                 anisotropyEnable)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, MaxAnisotropy, float, maxAnisotropy)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, CompareEnable, VkBool32,
                 compareEnable)
...
STRUCTURE_SETTER(SamplerCreateInfoBuilder, BorderColor, VkBorderColor,
                 borderColor)
STRUCTURE_SETTER(SamplerCreateInfoBuilder, UnnormalizedCoordinates, VkBool32,
