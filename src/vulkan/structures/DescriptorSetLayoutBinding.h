#ifndef VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORSETLAYOUTBINDING_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORSETLAYOUTBINDING_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_DESCRIPTORSETLAYOUTBINDING_H_
