#ifndef VULKAN_SRC_VULKAN_STRUCTURES_DEVICECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_DEVICECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_DEVICECREATEINFO_H_
