...
STRUCTURE_BUILDER_NO_TYPE(ImageSubresourceLayersBuilder, VkImageSubresourceLayers)
  STRUCTURE_SETTER(ImageSubresourceLayersBuilder, AspectMask, VkImageAspectFlags, aspectMask)
  STRUCTURE_SETTER(ImageSubresourceLayersBuilder, MipLevel, u32, mipLevel)
  STRUCTURE_SETTER(ImageSubresourceLayersBuilder, BaseArrayLayer, u32, baseArrayLayer)
