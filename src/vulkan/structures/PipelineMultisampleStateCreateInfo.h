#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEMULTISAMPLESTATECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEMULTISAMPLESTATECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEMULTISAMPLESTATECREATEINFO_H_
