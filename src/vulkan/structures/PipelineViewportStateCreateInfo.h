#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVIEWPORTSTATECREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVIEWPORTSTATECREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINEVIEWPORTSTATECREATEINFO_H_
