#ifndef VULKAN_SRC_VULKAN_STRUCTURES_PIPELINELAYOUTCREATEINFO_H_
#define VULKAN_SRC_VULKAN_STRUCTURES_PIPELINELAYOUTCREATEINFO_H_
...
#endif  // VULKAN_SRC_VULKAN_STRUCTURES_PIPELINELAYOUTCREATEINFO_H_
