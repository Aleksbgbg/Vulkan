#ifndef VULKAN_SRC_ENGINE_RESOURCE_COMPOSITERESOURCE_H_
#define VULKAN_SRC_ENGINE_RESOURCE_COMPOSITERESOURCE_H_
...
#endif  // VULKAN_SRC_ENGINE_RESOURCE_COMPOSITERESOURCE_H_
