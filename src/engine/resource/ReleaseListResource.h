#ifndef VULKAN_SRC_ENGINE_RESOURCE_RELEASELISTRESOURCE_H_
#define VULKAN_SRC_ENGINE_RESOURCE_RELEASELISTRESOURCE_H_
...
#endif  // VULKAN_SRC_ENGINE_RESOURCE_RELEASELISTRESOURCE_H_
