#ifndef VULKAN_SRC_ENGINE_PROPERTY_TYPE_GRAPHICALINTERFACE_H_
#define VULKAN_SRC_ENGINE_PROPERTY_TYPE_GRAPHICALINTERFACE_H_
...
#endif  // VULKAN_SRC_ENGINE_PROPERTY_TYPE_GRAPHICALINTERFACE_H_
