#ifndef VULKAN_SRC_ENGINE_UI_ELEMENTS_SLIDER_SLIDERUIELEMENT_H_
#define VULKAN_SRC_ENGINE_UI_ELEMENTS_SLIDER_SLIDERUIELEMENT_H_
...
#endif  // VULKAN_SRC_ENGINE_UI_ELEMENTS_SLIDER_SLIDERUIELEMENT_H_
