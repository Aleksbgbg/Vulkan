#ifndef SRC_ENGINE_UI_ELEMENTS_TOGGLEBOX_TOGGLEBOXUIELEMENT_H_
#define SRC_ENGINE_UI_ELEMENTS_TOGGLEBOX_TOGGLEBOXUIELEMENT_H_
...
#endif  // SRC_ENGINE_UI_ELEMENTS_TOGGLEBOX_TOGGLEBOXUIELEMENT_H_
