#ifndef VULKAN_SRC_ENGINE_COMPOSITION_SPAWNDEPENDENCIES_H_
#define VULKAN_SRC_ENGINE_COMPOSITION_SPAWNDEPENDENCIES_H_
...
#endif  // VULKAN_SRC_ENGINE_COMPOSITION_SPAWNDEPENDENCIES_H_
