#ifndef VULKAN_SRC_ENGINE_COMPOSITION_PARAMETER_UTILS_H_
#define VULKAN_SRC_ENGINE_COMPOSITION_PARAMETER_UTILS_H_
...
#endif  // VULKAN_SRC_ENGINE_COMPOSITION_PARAMETER_UTILS_H_
