#ifndef SRC_ENGINE_COMPOSITION_COMPOSITIONBUILDER_H_
#define SRC_ENGINE_COMPOSITION_COMPOSITIONBUILDER_H_
...
#endif  // SRC_ENGINE_COMPOSITION_COMPOSITIONBUILDER_H_
