#ifndef VULKAN_SRC_GAME_RENDERS_SCENEDESCRIPTORBINDER_H
#define VULKAN_SRC_GAME_RENDERS_SCENEDESCRIPTORBINDER_H
...
#endif  // VULKAN_SRC_GAME_RENDERS_SCENEDESCRIPTORBINDER_H
