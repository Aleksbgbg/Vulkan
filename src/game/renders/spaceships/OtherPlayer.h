#ifndef VULKAN_SRC_GAME_RENDERS_SPACESHIPS_OTHERPLAYER_H_
#define VULKAN_SRC_GAME_RENDERS_SPACESHIPS_OTHERPLAYER_H_
...
#endif  // VULKAN_SRC_GAME_RENDERS_SPACESHIPS_OTHERPLAYER_H_
