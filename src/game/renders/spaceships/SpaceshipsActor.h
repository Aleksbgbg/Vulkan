#ifndef VULKAN_SRC_GAME_RENDERS_SPACESHIPS_SPACESHIPSACTOR_H_
#define VULKAN_SRC_GAME_RENDERS_SPACESHIPS_SPACESHIPSACTOR_H_
...
#endif  // VULKAN_SRC_GAME_RENDERS_SPACESHIPS_SPACESHIPSACTOR_H_
