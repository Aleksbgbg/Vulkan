#ifndef VULKAN_SRC_GAME_RENDERS_PARTICLES_PARTICLESPAWNER_H_
#define VULKAN_SRC_GAME_RENDERS_PARTICLES_PARTICLESPAWNER_H_
...
#endif  // VULKAN_SRC_GAME_RENDERS_PARTICLES_PARTICLESPAWNER_H_
