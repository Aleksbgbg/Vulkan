#ifndef VULKAN_SRC_GENERAL_ALGORITHMS_HUFFMANTREE_H_
#define VULKAN_SRC_GENERAL_ALGORITHMS_HUFFMANTREE_H_
...
#endif  // VULKAN_SRC_GENERAL_ALGORITHMS_HUFFMANTREE_H_
