#ifndef VULKAN_SRC_GENERAL_WINDOWING_LINUX_LINUXWINDOW_H_
#define VULKAN_SRC_GENERAL_WINDOWING_LINUX_LINUXWINDOW_H_
...
#endif  // VULKAN_SRC_GENERAL_WINDOWING_LINUX_LINUXWINDOW_H_
