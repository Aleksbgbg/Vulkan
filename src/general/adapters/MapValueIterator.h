#ifndef VULKAN_SRC_GENERAL_ADAPTERS_MAPVALUEITERATOR_H_
#define VULKAN_SRC_GENERAL_ADAPTERS_MAPVALUEITERATOR_H_
...
#endif  // VULKAN_SRC_GENERAL_ADAPTERS_MAPVALUEITERATOR_H_
