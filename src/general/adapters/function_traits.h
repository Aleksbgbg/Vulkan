#ifndef VULKAN_SRC_GENERAL_ADAPTERS_FUNCTION_TRAITS_H_
#define VULKAN_SRC_GENERAL_ADAPTERS_FUNCTION_TRAITS_H_
...
#endif  // VULKAN_SRC_GENERAL_ADAPTERS_FUNCTION_TRAITS_H_
