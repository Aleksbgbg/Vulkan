#ifndef SRC_RENDERER_VERTICES_STRUCTUREDVERTEXDATA_H_
#define SRC_RENDERER_VERTICES_STRUCTUREDVERTEXDATA_H_
...
#endif  // SRC_RENDERER_VERTICES_STRUCTUREDVERTEXDATA_H_
