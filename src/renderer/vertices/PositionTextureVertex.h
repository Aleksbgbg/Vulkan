#ifndef VULKAN_SRC_RENDERER_VERTICES_POSITIONTEXTUREVERTEX_H_
#define VULKAN_SRC_RENDERER_VERTICES_POSITIONTEXTUREVERTEX_H_
...
#endif  // VULKAN_SRC_RENDERER_VERTICES_POSITIONTEXTUREVERTEX_H_
