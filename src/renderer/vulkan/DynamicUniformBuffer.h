#ifndef VULKAN_SRC_RENDERER_VULKAN_DYNAMICUNIFORMBUFFER_H_
#define VULKAN_SRC_RENDERER_VULKAN_DYNAMICUNIFORMBUFFER_H_
...
#endif  // VULKAN_SRC_RENDERER_VULKAN_DYNAMICUNIFORMBUFFER_H_
