#ifndef SRC_RENDERER_VULKAN_API_MEMORY_DEVICEMEMORYALLOCATOR_H_
#define SRC_RENDERER_VULKAN_API_MEMORY_DEVICEMEMORYALLOCATOR_H_
...
#endif  // SRC_RENDERER_VULKAN_API_MEMORY_DEVICEMEMORYALLOCATOR_H_
