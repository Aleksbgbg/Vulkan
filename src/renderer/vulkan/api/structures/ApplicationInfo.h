#ifndef SRC_RENDERER_VULKAN_API_STRUCTURES_APPLICATIONINFO_H_
#define SRC_RENDERER_VULKAN_API_STRUCTURES_APPLICATIONINFO_H_
...
#endif  // SRC_RENDERER_VULKAN_API_STRUCTURES_APPLICATIONINFO_H_
