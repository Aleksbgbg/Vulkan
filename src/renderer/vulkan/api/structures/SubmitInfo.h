#ifndef VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_SUBMITINFO_H_
#define VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_SUBMITINFO_H_
...
#endif  // VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_SUBMITINFO_H_
