#ifndef SRC_RENDERER_VULKAN_API_STRUCTURES_DESCRIPTORIMAGEINFO_H_
#define SRC_RENDERER_VULKAN_API_STRUCTURES_DESCRIPTORIMAGEINFO_H_
...
#endif  // SRC_RENDERER_VULKAN_API_STRUCTURES_DESCRIPTORIMAGEINFO_H_
