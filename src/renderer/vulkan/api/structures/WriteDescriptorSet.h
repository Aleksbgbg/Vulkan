#ifndef VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_WRITEDESCRIPTORSET_H_
#define VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_WRITEDESCRIPTORSET_H_
...
#endif  // VULKAN_SRC_RENDERER_VULKAN_API_STRUCTURES_WRITEDESCRIPTORSET_H_
