#ifndef SRC_RENDERER_VULKAN_RENDER_GRAPH_RENDERGRAPH_H_
#define SRC_RENDERER_VULKAN_RENDER_GRAPH_RENDERGRAPH_H_
...
#endif  // SRC_RENDERER_VULKAN_RENDER_GRAPH_RENDERGRAPH_H_
