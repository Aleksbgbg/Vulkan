#ifndef SRC_CORE_THREADING_MULTITHREADEDMESSAGEQUEUE_H_
#define SRC_CORE_THREADING_MULTITHREADEDMESSAGEQUEUE_H_
...
#endif  // SRC_CORE_THREADING_MULTITHREADEDMESSAGEQUEUE_H_
